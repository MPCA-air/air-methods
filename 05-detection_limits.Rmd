...
- Types of detection limits (what detection limit the lab calculates, where it is, where it is not and when not to use what lims has) 
- Does a value equal to the detection limit count as detected? __“YES!”__ 
- Things to consider when there are more than one detection limit per year.
    - Discuss averaging two detection limit years and using that instead of the previous detection limit. 
