...
- Annual method detection limits used for data analysis are stored on the X-drive at `X:\\Databases\\AQ\\AQ Lab\\Data Analysis\\Air Toxics\\Detection Limits\\Annual Detection Limits (micrograms).xlsx`
- Use the `ParamYear` field to join data
