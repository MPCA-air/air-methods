...
Click below to view an example of the methods above.
...
```{r, echo=F, fig.cap ="Unique ID column added."}
...
```{r cleaner-data, echo=F, fig.cap =' Final data set with 1 duplicate removed.'}
