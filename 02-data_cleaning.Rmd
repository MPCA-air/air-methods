...
1. Document your process. Wait, you did that by writing it in an R script.
...
qualified_data <- left_join(qualified_data, qualifiers, by = c("qual_code" = "Qualifier Code"))

##review qualifier types in the data
unique(qualifier_data$`Qualifier Description`)

##remove qualified data if appropriate
data_to_use <- filter(qualifier_data, is.na(qual_code))
