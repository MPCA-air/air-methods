...
This section describes how to access air monitoring and modeling data. 
...
con <- dbConnect(drv, dbname="wair",host='eiger',user=username,password=pass)## Open a connection 
...
<!--chapter:end:015-quality_assurance-section.Rmd-->
...
<!--chapter:end:85-additional_resources.Rmd-->
...
<!--chapter:end:91-AQI_explorer.Rmd-->
...
<!--chapter:end:93-airtoxics_explorer.Rmd-->
