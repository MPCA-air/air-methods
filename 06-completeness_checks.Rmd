...
1. Based on the monitoring schedule, record the total _expected samples_ for each year and quarter.
    - Air toxics monitors follow a fixed sampling schedule provided by the EPA. (See the [Air Toxics Monitoring Calendar](https://www3.epa.gov/ttn/amtic/calendar.html))
...
# Load EPA's air toxics monitoring schedule
schedule <- read_csv()
