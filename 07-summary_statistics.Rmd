...
```{r out.width='40%', echo=F, warning = F, message = F,  fig.align="center"}
library(knitr)
library(DT)
library(kableExtra)
...
\@ref(roll365)     __Rolling 365 day summaries__   
