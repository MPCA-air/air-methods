...
First it's always a good idea to look at the data. If there are a lower number of numeric data points the statistical tests that follow may not be necessary.
