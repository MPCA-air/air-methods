...
Environmental monitoring data can be subject to error. Some important errors to check for include:
...
_First it's always a good idea to look at the data
