...
![](https://avatars3.githubusercontent.com/u/22032646?s=400&v=4){width="260" align="right" style="margin-left: 20px; margin-right: 20px; margin-top: -42px;"}

<br>

This section includes some _Best practices_ to promote efficient and accurate data analysis with `R`.  
...
Use packages within the _Tidyverse_ as much as possible for your analysis. 

![](images/tidy_packages.PNG){width="450"}

These packages work in harmony by sharing a common data format and syntax. Your scripts will be more readable by others and future you when your scripts stick to the world of _tidy_ data.
...
__Download the new R version__
```{r, eval=F}
updateR()
```
...
For complex analysis projects many small components is better than one big super script. As much as possible, try to create small functions to perform each task within in your analysis. If it's a function that you will use across multiple projects, it is often helpful to save the function to it's own script. These functions will become reusable building blocks that both future you and others can apply to their own projects. 
